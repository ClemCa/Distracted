...
export default function Selector({ onNow, onLater, onNotToday, task, urgentCount }: { onNow: () => void; onLater: () => void; onNotToday: () => void; task: Task; urgentCount: number }) {
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="flex items-center gap-5">
        <div className="flex h-32 w-32 flex-col items-center justify-center gap-1 rounded-xl border border-emerald-500/40 bg-emerald-500/10 text-emerald-300">
        ...
        <div className="flex h-32 w-32 flex-col items-center justify-center gap-1 rounded-xl border border-amber-500/40 bg-amber-500/10 text-amber-300">
          <span className="text-xl leading-none">→</span>
          <span className="text-center text-xs font-semibold uppercase tracking-wide">Later</span>
        </div>
      </div>

      <div className="flex h-32 w-32 items-center justify-center gap-2 rounded-xl border border-rose-500/40 bg-rose-500/10 text-rose-300">
        <span className="text-xl leading-none">↓</span>
